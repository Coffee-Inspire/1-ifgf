            ...
            <div className="row d-block">
                ...
                <div className="div-background" style={{ backgroundImage: `url("/home/bg-5.png")` }}>
                        <div className="h-100 w-100 d-flex align-items-center position-relative">
                            <div className="shadow py-5 d-flex w-100 justify-content-center">
                                <div className="text-center">
                                    <div className="fs-5 fw-700 text-uppercase">IFGF Kids</div>
                                    <div className="pt-3">"IFGF Kids helps you to grow spiritually, and that requires more than meeting at Sunday services."</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="content">
                    <div className="py-2 d-flex w-100 justify-content-center">
                        <button className="col-5 text-uppercase py-2 px-3">Join with us!</button>
                    </div>
                    <div className="py-2 d-flex w-100 justify-content-center">
                        <button className="col-5 text-uppercase py-2 px-3">Contact us</button>
                    </div>
                </section>
            </div>
        </div>
